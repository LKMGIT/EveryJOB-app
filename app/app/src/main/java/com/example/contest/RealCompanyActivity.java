...
public class RealCompanyActivity extends AppCompatActivity {


    private static final String TAG = "RealCompanyActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.real_company_info);
        ...
        call_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:15881519"));
        ...
        sms_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // SMS 작성 화면으로 이동
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("sms:15881519"));
    ...
    private void fetchCompanyDetails(Long id) {
        ...
        apiService.getMainJobData(id).enqueue(new Callback<LocationDetailResponseDTO>() {
            @Override
            public void onResponse(Call<LocationDetailResponseDTO> call, Response<LocationDetailResponseDTO> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Log.d(TAG, "Company Name: " + details.getName());
                    ...
                    Toast.makeText(RealCompanyActivity.this, "회사 정보를 가져오는 데 실패했습니다.", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<LocationDetailResponseDTO> call, Throwable t) {
                ...
                Toast.makeText(RealCompanyActivity.this, "서버와의 연결에 실패했습니다.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RealCompanyActivity.this, HomeActivity.class);
                startActivity(intent);
            }
        });
    }
